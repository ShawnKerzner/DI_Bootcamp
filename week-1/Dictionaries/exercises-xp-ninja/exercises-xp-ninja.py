...
print(set(car_list))
car_string = ", ".join(set(car_list))
print(car_string)
print(f"There are {len(set(car_list))} companies now in the list")
...
reverse_words_sorted = [manufacturer[::-1] for manufacturer in sorted_manufacturers]
print(reverse_words_sorted)